...
def main():
    csv_file = 'ComparisonOutput\comprehensive_quality_check_run_test_batch7.csv'
    ideal_dir = 'IdealDXF'
    output_file = 'quality_check_report_batch_6.pdf'
    src_dir = 'Batch_7\B7_DXF_In' 
    mod_dir = 'Batch_7\B7_DXF_Out'
